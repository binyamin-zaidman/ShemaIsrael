  ...
  return (
    ...
    >
      <div className="bg-image w-100 d-flex justify-content-center align-items-center mt-5">
        <h2 className="main-title fs-5 fw-normal text-center p-5 d-flex flex-column" id="text-top">
      ...
      <div className="w-100 d-flex justify-content-center align-items-center mt-3" data-aos="zoom-in">
      ...
      <ul className="list-group w-100 p-2">
        ...
        <li className="mb-3 list-group-item text-end mb-0 bg-color-gradient text-white border-bottom-0" data-aos="fade-up">
          <p className="main-title fs-4"> מדריכים מקצועיים <span className="main-title fw-normal fs-6"> בעלי ידע רחב במאורעות שהתרחשו, בסיפורים האישיים ובנקודות ההתרחשויות </span> </p>
        </li>
        <li className="mb-3 list-group-item text-end mb-0 bg-color-gradient text-white border-bottom-0" data-aos="fade-up">
          <p className="main-title fs-4"> חוויה אישית <span className="main-title fw-normal fs-6"> מפגשים עם ניצולים והרצאות מרתקות </span> </p>
        </li>
        <li className="mb-3 list-group-item text-end mb-0 bg-color-gradient text-white border-bottom-0" data-aos="fade-up">
          <p className="main-title fs-4"> גמישות <span className="main-title fw-normal fs-6"> סיורים קבוצתיים ופרטיים אפשרות לרכבים פרטיים </span> </p>
        </li>
      </ul>
    </div>
  );
